...
/*   Updated: 2015/01/14 05:09:02 by mcanal           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
# define HEADER_H
# define DEBUG { ft_putstr_clr(__func__, "r"); ft_putstr_clr(" - line: ", "r");	\
		ft_putnbr_clr(__LINE__, "r"); ft_putstr("\n"); } //ToDEL
# define PROMPT { ft_putstr_clr("$MinniChelHein> ", "white"); }
